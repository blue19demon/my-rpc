...
import com.rpc.core.provider.ServiceAnnotationBeanPostProcessor;
...
public class AnnotationConfigUtils {
    ...
    public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
            BeanDefinitionRegistry registry, @Null Object source) {
    ...
    private static void addAttributesIfNotNull(
            Set<AnnotationAttributes> result, @Null Map<String, Object> attributes) {
